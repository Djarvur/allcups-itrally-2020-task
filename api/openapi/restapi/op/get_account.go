...
type GetAccountHandlerFunc func(GetAccountParams) GetAccountResponder

// Handle executing the request and returning a response
func (fn GetAccountHandlerFunc) Handle(params GetAccountParams) GetAccountResponder {
	return fn(params)
}

// GetAccountHandler interface for that can handle valid get account params
type GetAccountHandler interface {
	Handle(GetAccountParams) GetAccountResponder
}
